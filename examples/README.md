...
| LLM: плавная кривая | [llm-sqrt.csv](llm-sqrt.csv) | [llm-sqrt-output/report.html](llm-sqrt-output/report.html) | P1/P2/LLM; новая формула точнее на этом holdout |
| LLM: два режима | [llm-two-regime.csv](llm-two-regime.csv) | [llm-two-regime-output/report.html](llm-two-regime-output/report.html) | P1/P2/LLM; алгоритмическая P2 точнее LLM |
...
`deepseek/deepseek-v4-flash-0731`. Пакеты сохранены без изменения содержимого,
...
|---|---:|---:|---:|
| Плавная кривая | 0.006624 | 0.005849 | 0.005300 |
| Два режима | 0.144648 | 0.009506 | 0.190230 |
